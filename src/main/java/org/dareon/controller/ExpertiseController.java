...
/**
 * This is the Controller for Expertise field of dareon website , this defines
 * request mapping for the functionalities of expertise service model.
 */
...
public class ExpertiseController {
	...
	/**
	 *
	 * @param expertiseService
	 *            details about the expertise of user in different selected fields
	 * @param classificationService
	 *            details about the classified fields selected by the user
	 * @param userService
	 *            details about the particular authenticated user
	 */
	@Autowired
	public ExpertiseController(ExpertiseService expertiseService, ClassificationService classificationService,
	 ...
	 * 
	 * @param model
	 *            defines the expertise model in model class of MVC
	 * @return the system to "expertise/addexpertise" url
	 * @throws JSONException
	 *             throws exception for missing values
	 */
	...
	public String addExpertise(Model model) throws JSONException {
		...
		model.addAttribute("classificationTree",
				JsonClassificationTree.getClassificationTreeAsString(classificationService.list()));
	...
	/**
	 * 
	 * @param addExpertiseForm
	 *            details to be filled for the expertise of user
	 * @param model
	 *            defines the model for add expertise url
	 ...
	 * 
	 * @param model
	 *            details about the setvalue mdel for expertise field
	...
	/**
	 * 
	 * @param addExpertiseValueForm
	 *            details to be filled in fields of form
	 * @param model
	 *            defines expertise add form
